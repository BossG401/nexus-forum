    ...
    <div className="max-w-3xl">
      ...
      {posts.length === 0 && (
        <div className="glass-subtle clip-chamfer p-8 text-center mt-3 animate-fade-in corner-marks">
          <Trophy size={24} className="text-neon-gold/50 mx-auto mb-2" />
          <p className="text-slate-400/60 font-display font-black tracking-[0.5em] uppercase text-xs">ESPORTS INCOMING</p>
          <p className="text-slate-400/50 text-[10px] mt-2 font-mono">Live tournament threads and combat analysis loading...</p>
        </div>
      )}
    </div>
  )
